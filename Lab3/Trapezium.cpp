...
bool operator>(const Trapezium& left, const Trapezium& right)
{
	return left.side_a + left.side_b + left.side_c + left.side_d > right.side_a + right.side_b + right.side_c + right.side_d;
}
